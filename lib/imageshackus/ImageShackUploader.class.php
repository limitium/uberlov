...
class ImageShackUploader {
     ...
     */
    function upload($file, $optsize = null, $removeBar = true, $tags = null, $public = null, $contentType = null, $frameFilename = null) {
        if (!$contentType)
    ...
    function transload($url, $optsize = null, $removeBar = true, $tags = null, $public = null) {
        ...
        if ($this->cookie)
            $params[] = new stringpart('cookie', $this->cookie);
        $params[] = new stringpart('key', $this->developer_key);
        $params[] = new stringpart('a_username', 'uberlov@gmail.com');
        $params[] = new stringpart('a_password', 'qweqwe123');
        return $this->exec($endpoint, $params);
    }
