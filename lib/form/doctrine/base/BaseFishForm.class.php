...
/**
 * Fish form base class.
 *
 * @method Fish getObject() Returns the current form's model object
 *
 * @package    HT
 * @subpackage form
 ...
 */
abstract class BaseFishForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->validatorSchema->setPostValidator(
      new sfValidatorDoctrineUnique(array('model' => 'Fish', 'column' => array('name')))
    );

    $this->widgetSchema->setNameFormat('fish[%s]');
