...
abstract class BaseFishEventForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'schedule'           => new sfWidgetFormTextarea(),
      ...
      'fish_event_type_id' => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('FishEventType'), 'add_empty' => false)),
    ...
    $this->setValidators(array(
      ...
      'fish_event_type_id' => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('FishEventType'))),
