...
abstract class BaseAddressForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'road_id'      => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'road_id'      => new sfValidatorInteger(array('required' => false)),
      ...
      'route_id'     => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('Route'), 'required' => false)),
    ));
