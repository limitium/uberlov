...
/**
 * PhotoProfitVersion form base class.
 *
 * @method PhotoProfitVersion getObject() Returns the current form's model object
 *
 * @package    FISHERY
 * @subpackage form
 ...
 */
abstract class BasePhotoProfitVersionForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('photo_profit_version[%s]');
