 ...
 * @property Doctrine_Collection $Route
 * 
 ...
 * @method Doctrine_Collection getRoute()   Returns the current record's "Route" collection
 ...
 * @method Country             setRoute()   Sets the current record's "Route" collection
 * 
 * @package    FISHERY
 * @subpackage model
