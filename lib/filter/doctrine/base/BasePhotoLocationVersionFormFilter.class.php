...
/**
 * PhotoLocationVersion filter form base class.
 *
 * @package    FISHERY
 * @subpackage filter
 ...
 */
abstract class BasePhotoLocationVersionFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('photo_location_version_filters[%s]');
