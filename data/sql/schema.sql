...
CREATE TABLE point (id INT AUTO_INCREMENT, route_id INT, latitude DOUBLE, longitude DOUBLE, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX route_id_idx (route_id), PRIMARY KEY(id)) ENGINE = INNODB;
