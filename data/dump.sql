...
insert  into `friend`(`requester_id`,`accepter_id`,`accepted`) values (7,1,0);
...
insert  into `sf_guard_remember_key`(`id`,`user_id`,`remember_key`,`ip_address`,`created_at`,`updated_at`) values (15,7,'cdg4esudts84kwo4o8kcosokk40s0kw','127.0.0.1','2011-05-19 01:12:35','2011-05-19 01:12:35');
