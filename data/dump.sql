...
insert  into `location`(`id`,`name`,`description`,`depth`,`is_free`,`price`,`location_flow_id`,`location_fundus_id`,`location_relief_id`,`location_type_id`,`location_scope_id`,`address_id`,`created_by`,`updated_by`,`slug`,`created_at`,`updated_at`,`latitude`,`longitude`,`version`) values (485,'Рыболовно-охотничья база ПРОТОКА','',NULL,0,'',NULL,NULL,NULL,NULL,5,447,1,1,'160','2011-05-02 20:03:44','2011-05-02 20:03:44',45.864074329600001,48.141231536900001,2);
...
CREATE TABLE `location_show` (
  ...
  PRIMARY KEY (`id`),
  KEY `location_id_idx` (`location_id`),
  CONSTRAINT `location_show_location_id_location_id` FOREIGN KEY (`location_id`) REFERENCES `location` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;

/*Data for the table `location_show` */

insert  into `location_show`(`id`,`shows`,`location_id`) values (1,1,676);
...
insert  into `sf_guard_remember_key`(`id`,`user_id`,`remember_key`,`ip_address`,`created_at`,`updated_at`) values (18,7,'jfn4mnr4u1sg8sok0cookg0sc4gs880','217.15.196.51','2011-06-02 13:22:09','2011-06-02 13:22:09');
...
insert  into `sf_guard_user_profile`(`user_id`,`email_new`,`validate_at`,`validate`,`id`,`sex`,`birth_date`,`userpic`,`description`,`city_id`,`created_at`,`updated_at`) values (9,NULL,NULL,NULL,9,1,NULL,NULL,NULL,NULL,'2011-06-02 11:38:22','2011-06-02 11:40:59');
...
insert  into `style`(`id`,`name`) values (12,'Донная удочка');
